...
namespace Elemendid_vormis_TARpv23
{
    public partial class StartVorm : Form
    {
        ...
        public StartVorm()
        {
            ...
            pbox.Image = Image.FromFile(@"..\..\..\squidward.png");
        ...
        {
            string[] pildid = { "patrick.png", "spongebob.png", "squidward.png" };
        ...
        private void Btn_Click(object? sender, EventArgs e)
        {
            ...
            {
                TeineVorm teineVorm = new TeineVorm(500, 700);
                teineVorm.Show();
            }
        ...
        private void Tree_AfterSelect(object? sender, TreeViewEventArgs e)
        {
            ...
            {
                int x = 150; int y = 200;
                int buttonWidth = 100; int buttonSpacing = 10;
                Button btnEsimene = new Button { Text = "Esimene Vorm", Size = new Size(buttonWidth, 20), Location = new Point(x, y) };
                btnEsimene.Click += (sender, args) => new EsimeneVorm(500, 700).Show(); Controls.Add(btnEsimene);
                x += buttonWidth + buttonSpacing;
                Button btnTeine = new Button { Text = "Teine Vorm", Size = new Size(buttonWidth, 20), Location = new Point(x, y) };
                btnTeine.Click += (sender, args) => new TeineVorm(500, 700).Show(); Controls.Add(btnTeine);
                x += buttonWidth + buttonSpacing;
                Button btnKolmas = new Button { Text = "Kolmas Vorm", Size = new Size(buttonWidth, 20), Location = new Point(x, y) };
                btnKolmas.Click += (sender, args) => new KolmasVorm(500, 700).Show(); Controls.Add(btnKolmas);
            }
        }
